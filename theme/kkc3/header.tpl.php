...
<head<?php print $data['header_attrs'];?>>
    ...
    <link rel="shortcut icon" href="/theme/kkc3/favicon.ico" type="image/vnd.microsoft.icon" />
    ...
    <header class="header" role="banner">
        ...
        <div id="h-left">
            ...
            <a href="/" title="Home" rel="home" class="header__logo">
                <img src="<?=Config::get('site_logo')?>" width="45" height="45"alt="Tuzac home" class="header__logo-image">
                <span><?=Config::get('site_abbr')?><span class="not-in-mobile">- 高清美女图集</span></span>
            </a>
                    ...
                    <div>
                        <div class="container-inline">
                            <div class="form-item form-type-textfield form-item-search-block-form">
                                <input title="Enter the terms you wish to search for." placeholder="搜索..." type="text" id="edit-search-block-form--2" name="term" value="" size="15" maxlength="1024" class="form-text">
                            </div>
...
<div class="mobile-only mobile-banner" style="width:100%; padding: 15px 0 0 0; text-align: center">
    ...
    <ins id="1029424" data-width="300" data-height="50"></ins>
    <script type="text/javascript" data-cfasync="false" async>(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1029424});</script>
</div>
<!--JuicyAds END-->
