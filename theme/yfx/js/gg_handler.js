  ...
  function moveAds(flag) {
    if ($(".all-tags-page")[0]){
      ...
      if (maInterval === null) {
        ...
        if (
          jQuery('#block-ads-right-sidebar-ad-1 > div > div').length > 0
          && jQuery('#block-ads-right-sidebar-ad-2 > div > div').length > 0
          && jQuery('#block-ads-right-sidebar-ad-3 > div > div').length > 0
        ) {
          var newAdClass = 'm-block-ad';
          if (flag) {
            // var a1 = jQuery('#block-ads-right-sidebar-ad-1').html();
            // var a2 = jQuery('#block-ads-right-sidebar-ad-2').html();
            // var a3 = jQuery('#block-ads-right-sidebar-ad-3').html();
