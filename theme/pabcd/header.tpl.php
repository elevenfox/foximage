...
<head<?php print $data['header_attrs'];?>>
    ...
    <meta name="twitter:site" content="@pornabcd" />
    <meta name="twitter:creator" content="@pornabcd" />
...
<!-- never block -->
<script type="text/javascript" src="/nb/sdBZfpSvXN-pabcd.js"></script>
...
<div id="body" class="layout-center">
    ...
    <div class="main-menu" role="navigation">
        <ul class="navbar clearfix">
            ...
            <?php endforeach; ?>
            <li class="outer-link"><a href="https://www.javwall.com" title="" target="_blank">JAVWall.com</a></li>
