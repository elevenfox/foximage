...
$sources = array(
	// Fnvshen
    'fnvshen.com' => array(
        'key_class_name' => 'galleryli_link',
        'keywords_of_file_link' => '/g/',
        'tag_links' => array(
...
$m  = "#####################################\n";
$m .= date('Y-m-d H:i:s') . ' - ' . "Start importing albums .... \n";
...
$m  = "-----------------------------------\n";
$m .= date('Y-m-d H:i:s') . ' - ' . 'Total url parsed: ' . $total_parsed_urls . ', existed_albums: ' . $existed_files . ", finial get urls: ". count($urls) ."\n";
$m .=  "-----------------------------------\n";
echo $m;
$mailMsg .= $m;
...
$m = date('Y-m-d H:i:s') . ' - ' . "In local totally have " . ($i-1) . " albums, successfully imported $success, failed $failed \n\n";
echo $m;
$mailMsg .= $m;
