    ...
    <article class="file content" itemscope itemtype="http://schema.org/fileObject">
        ...
        <?php else:?>
          ...
          <div class="task" id="task">
            ...
            <div class="cpa-chaturbate" style="width: 100%; text-align:center">👀 想看她们**动起来**？进入<a href="https://chaturbate.com/in/?tour=grq0&campaign=jwMl4&track=kkc3_album_1" target="_blank" rel="noopener noreferrer">真人直播 👉 </a></div>
            ...
            <div class="cpa-chaturbate" style="width: 100%; text-align:center"><a href="https://chaturbate.com/in/?tour=grq0&campaign=jwMl4&track=kkc3_album_2" target="_blank" rel="noopener noreferrer">🔥 她们正在直播中，点击观看实时互动！</a></div>
          </div>
          <?php
            import('Pager');
            $pager = new Pager(
