    ...
    <div class="content-container privacy-page search-result-list-pages">
        ...
        <div id="content" class="content">
            ...
            <div class="text-container">
                ...
                <p>If you believe any material accessible on JAVWall infringes your copyright, you may submit a copyright infringement notification. These requests should only be submitted by the copyright owner or an agent authorized to act on the owner’s behalf with the following information:</p>
                ...
                <p>(c) a description of where the material that you claim is infringing is located on JAVWall (preferably including specific url’s associated with the material);</p>
                ...
                <p>(b) a description of where the material was located within JAVWall or the Content before such material was removed and/or disabled (preferably including specific url’s associated with the material);</p>
                ...
                <p>In accordance with the DMCA and other applicable law, we have adopted a policy of terminating or disabling, in appropriate circumstances and at our sole discretion, the accounts of users who are deemed to be repeat infringers. We may also at our sole discretion limit access to JAVWall, terminate or disable the accounts of any users who infringe any intellectual property rights of others, whether or not there is any repeat infringement.</p>

                <p><br>
                    <strong>TAKE DOWN PROCEDURE</strong></p>

                <p>JAVWall implements the following “notification and takedown” procedure upon receipt of any notification of claimed copyright infringement. &nbsp;JAVWall reserves the right at any time to disable access to, or remove any material or activity accessible on or from JAVWall or any Materials claimed to be infringing or based on facts or circumstances from which infringing activity is apparent. It is the firm policy of JAVWall to terminate the account of repeat copyright infringers, when appropriate, and JAVWall will act expeditiously to remove access to all material that infringes on another’s copyright, according to the procedure set forth in 17 U.S.C. §512 of the Digital Millennium Copyright Act (“DMCA”). JAVWall DMCA Notice Procedures are set forth in the preceding paragraph. If the notice does not comply with §512 of the DMCA, but does comply with three requirements for identifying sites that are infringing according to §512 of the DMCA, JAVWall shall attempt to contact or take other reasonable steps to contact the complaining party to help that party comply with the notice requirements. When we receive a valid notice, JAVWall will expeditiously remove and/or disable access to the infringing material and shall notify the affected user. Then, the affected user may submit a counter-notification to us containing a statement made under penalty of perjury that the user has a good faith belief that the material was removed because of misidentification of the material. After we receive the counter-notification, it will replace the material at issue within 10-14 days after receipt of the counter-notification unless we receive notice that a court action has been filed by the complaining party seeking an injunction against the infringing activity. JAVWall reserves the right to modify, alter or add to this policy, and all users should regularly check back to these Terms and Conditions to stay current on any such changes.</p>

                <p><br>
                    <strong>MODIFICATIONS TO POLICY</strong></p>

                <p>JAVWall reserves the right to modify, alter or add to this policy, and all affected persons should regularly check back regularly to stay current on any such changes.</p>
