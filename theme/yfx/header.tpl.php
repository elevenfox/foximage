...
<head<?php print $data['header_attrs'];?>>
    ...
    <link rel="shortcut icon" href="/theme/<?=$theme->themeName?>/favicon.ico" type="image/vnd.microsoft.icon" />
    ...
    <meta name="twitter:site" content="@youfreex" />
    <meta name="twitter:creator" content="@youfreex" />
...
<div id="body" class="layout-center">
    ...
    <header class="header" role="banner">
        ...
        <div id="h-left">
            ...
            <span id="quick-nav">
                <img src="/theme/<?=$theme->themeName?>/images/menu100bsa.png" title="Quick Navigation" alt="Quick Navigation">
            </span>
                <span id="mobile-back">
                <a href="javascript:history.go(-1)" class="ui-link"><img src="/theme/<?=$theme->themeName?>/images/back100bsa.png" title="Go Back" alt="Go Back"></a>
            </span>
            </div>
            <a href="/" title="Home" rel="home" class="header__logo">
                <img src="/theme/<?=$theme->themeName?>/logo.png" alt="Home" class="header__logo-image">
            </a>
            <div id="search-button-div">
                <a href="#" id="buttonSearch" class="ui-link"><img src="/theme/<?=$theme->themeName?>/images/search100bsa.png" title="Search" alt="Search"></a>
    ...
    <div class="main-menu" role="navigation">
        <ul class="navbar clearfix">
            ...
            <?php endforeach; ?>
            <li class="outer-link"><a href="https://www.pornabcd.com" title="PornABCD.com" target="_blank">PornABCD.com</a></li>
            <li class="outer-link last"><a href="https://www.javwall.com" title="JAVWall.com" target="_blank">JAVWall.com</a></li>
        </ul>
    </div>
