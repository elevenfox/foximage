...
class foxMysqli extends DB {	
	...
	public function __construct($host, $port, $user, $pass, $dbname = null) {
		...
		$this->_pass = $pass;
		$this->_dbname = $dbname;
		$this->_newLink = Config::get('db_new_link');
	...
	public function connect() {
		if (!$this->_link) {
            ...
            if(!$mysqli) die("$this->_host: 数据库服务器连接失败");
