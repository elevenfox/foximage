...
<article class="clearfix node-teaser" itemscope itemtype="http://schema.org/VideoObject">
    <div class="task" id="task" style="position: relative">
        ...
        <div class="teaser-video-detail">
            ...
            <div class="teaser-video-info"><i class="icon-white glyphicon glyphicon-upload"></i> By: <?=$data['user_name'] ? $data['user_name'] : 'Anonymous' ?></div>
            <div class="teaser-video-info right" itemprop="userInteractionCount">
